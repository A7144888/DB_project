                    ...
                    <?php
                        ...
                        if($stmt = $db->query($query)){
                            ...
                            while($result=mysqli_fetch_object($stmt)){
                                ...
                                echo '<td>';
                                echo '<form method="POST" action="drink_mdy.php?id=' . $result->dId . '" style="display:inline;">';
                                echo '<input type="submit" value="修改" class="btn-edit">';
                                echo '</form>';
                                echo '<form method="POST" action="drink_del.php?id=' . $result->dId . '" style="display:inline;">';
